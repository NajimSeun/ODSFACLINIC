 ...
 */
@Entity
@DiscriminatorValue("hpt")
public class HepatitisPanelTest extends Investigation implements Serializable, Requestable {

    private final static String NAME = "HepatitisPanelTest" ;

    public HepatitisPanelTest() {
