...
public class PackedCellVolume extends Investigation implements Serializable , Requestable{
    
    private static final String NAME = "PackedCellVolume" ; 
    
    public PackedCellVolume() {
